...
<blockquote>🫵 Select Your Language And Continue...</blockquote>"""
...
<blockquote>‣ Fɪʟᴇ ꜱɪᴢᴇ : {file_size}</blockquote>

<b>Nᴏᴛᴇ - Tʜɪs ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ 10 ᴍɪɴᴜᴛᴇs ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ɪssᴜᴇs. 
Pʟᴇᴀsᴇ ғᴏʀᴡᴀʀᴅ ɪᴛ ᴛᴏ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇs ᴏʀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ғʀᴏᴍ ᴛʜᴇʀᴇ.</b>""" 
...
2. சினிமாவின் பெயர் டைப் செய்யவும்

3. சரியான பெயரை காப்பி செய்யவும்

4. டெக்ஸ்ட் பேஸ்ட் செய்யவும்

5. அனுப்பவும்.

உதாரணம் :- <blockquote>Avatar The Way of Water</blockquote>

🚫 பயன்படுத்த வேண்டாம் ➦ ':(!,./)


<blockquote>💠உலகில் உள்ள அனைத்து மொழிகளிலும் சினிமாக்கள் நீங்கள் இங்கு இருந்து பெற முடியும்..வேகமாக கீழே கொடுக்கப்பட்டுள்ள லிங்க் மூலம் குழுவில் சேர்ந்திடுங்கள்👇🥰

@moviemania_TG</blockquote>"""
...
3.Copy the correct name

4. Paste the text

5.Send.

Example: <blockquote>Avatar The Way of Water</blockquote>

🚫Do not use ➦ ':(!,./)


<blockquote>💠All movies in all languages of the world are available here. Join the group quickly through the link below👇😌
 @moviemania_TG</blockquote>"""
...
🎥సినిమా అభ్యర్థించే విధానం

1. గూగుల్ తెరవండి

2. సినిమాని పేరు టైప్ చేయండి

3. సరైన పేరు కాపీ చేసుకోండి

4. టెక్స్ట్ పెస్ట్ చేయండి

5. పంపించండి.

ఉదాహరణ :- <blockquote>Avatar The Way of Water</blockquote>

🚫 ఉపయోగించకూడదు ➦ ':(!,./)


<blockquote>💠ప్రపంచంలోని అన్ని భాషలలో సినిమాలు మీరు ఇక్కడ నుండి పొందవచ్చు..వేగంగా కింది లింక్ ద్వారా గ్రూపులో చేరండి👇🥰
...
🎥सिनेमा अनुरोध करने का तरीका

1. गूगल खोलें

2. सिनेमा का नाम टाइप करें

3. सही नाम कॉपी करें

4. टेक्स्ट पेस्ट करें

5. भेजें।

उदाहरण :- <blockquote>Avatar The Way of Water</blockquote>

🚫 उपयोग न करें ➦ ':(!,./)


<blockquote>💠दुनिया की सभी भाषाओं में फिल्में आप यहाँ से प्राप्त कर सकते हैं..जल्दी से नीचे दिए गए लिंक के माध्यम से ग्रुप में जुड़ें👇🥰
...
🎥സിനിമ അഭ്യർത്തിക്കണ്ട രീതി 

1.ഗൂഗിൾ തുറക്കുക  

2.സിനിമയുടെ പേര് ടൈപ്പ് ചെയ്യുക  

3.ശരിയായ പേര് കോപ്പി ചെയ്യുക  

4.ടെക്സ്റ്റ് പേസ്റ്റ് ചെയ്യുക  

5.അയക്കുക.


ഉദാഹരണം :- <blockquote>Avatar The Way of Water</blockquote>

🚫 ഉപയോഗിക്കരുത് ➦ ':(!,./)


<blockquote>💠ലോകത്തിലുള്ള എല്ലാ ഭാഷയിലെയും സിനിമകൾ നിങ്ങൾക്ക് ഇവിടെ നിന്നും കിട്ടുന്നതാണ്..വേഗം താഴെ കൊടുത്തിരിക്കുന്ന ലിങ്ക് വഴി ഗ്രൂപ്പിൽ ജോയിൻ ചെയ്യൂ👇🥰
...
🎥سینما کی درخواست کا طریقہ

1. گوگل کھولیں  

2. فلم کا نام ٹائپ کریں  

3. صحیح نام کاپی کریں  

4. ٹیکسٹ پیسٹ کریں  

5. بھیج دیں۔  

مثال :- <blockquote>Avatar The Way of Water</blockquote>  

🚫 استعمال نہ کریں ➦ ':(!,./)  

<blockquote>💠دنیا کی تمام زبانوں میں فلمیں آپ یہاں سے حاصل کر سکتے ہیں..نیچے دیے گئے لنک کے ذریعے گروپ میں جلدی شامل ہوں👇🥰  
...
🎥સિનેમાની વિનંતી કરવાની રીત

1. ગુગલ ખોલો  

2. ફિલ્મનું નામ ટાઈપ કરો  

3. યોગ્ય નામ કોપી કરો  

4. ટેક્સ્ટ પેસ્ટ કરો  

5. મોકલો।  

ઉદાહરણ :- <blockquote>Avatar The Way of Water</blockquote>  

🚫 ઉપયોગ ન કરો ➦ ':(!,./)  

<blockquote>💠વિશ્વની તમામ ભાષાઓમાંની ફિલ્મો તમે અહીંથી મેળવી શકો છો..ઝડપી રીતે નીચે આપેલા લિંક દ્વારા ગ્રૂપમાં જોડાઓ👇🥰  
...
🎥ಚಿತ್ರವನ್ನು ಕೇಳುವ ವಿಧಾನ  

1. ಗೂಗಲ್ ತೆರೆಯಿರಿ  

2. ಚಿತ್ರದ ಹೆಸರು ಟೈಪ್ ಮಾಡಿ  

3. ಸರಿಯಾದ ಹೆಸರನ್ನು ಕಾಪಿ ಮಾಡಿ  

4. ಟೆಕ್ಸ್ಟ್ ಪೇಸ್ಟ್ ಮಾಡಿ  

5. ಕಳುಹಿಸಿ.  

ಉದಾಹರಣೆ :- <blockquote>Avatar The Way of Water</blockquote>  

🚫 ಬಳಸಬೇಡಿ ➦ ':(!,./)  

<blockquote>💠ವಿಶ್ವದ ಎಲ್ಲಾ ಭಾಷೆಯ ಚಿತ್ರಗಳನ್ನು ನೀವು ಇಲ್ಲಿ ಪಡೆಯಬಹುದು..ತಕ್ಷಣವೇ ಕೆಳಗಿನ ಲಿಂಕ್ ಮೂಲಕ ಗ್ರೂಪಿಗೆ ಸೇರಿ👇🥰  
...
🎥সিনেমা আবদার করার পদ্ধতি  

1. গুগল খুলুন  

2. সিনেমার নাম টাইপ করুন  
...
উদাহরণ :- <blockquote>Avatar The Way of Water</blockquote>  

🚫 ব্যবহার করবেন না ➦ ':(!,./)  

<blockquote>💠বিশ্বের সব ভাষার সিনেমা আপনি এখানে পেতে পারেন..তাড়াতাড়ি নিচে দেওয়া লিঙ্কে ক্লিক করে গ্রুপে যোগ দিন👇🥰  
